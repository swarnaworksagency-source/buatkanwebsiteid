...
export default function Portofolio({ portofolio, layanan, waLink }: SectionProps) {
    ...
    return (
        <section id="proyek" className="ng-port-sec" style={{ backgroundColor: NEON.bg, backgroundImage: "radial-gradient(ellipse 55% 50% at 50% 80%, color-mix(in srgb, var(--ng-accent, #a3e635) 4%, transparent) 0%, transparent 65%)", padding: "60px 36px", minHeight: "100vh", display: "flex", alignItems: "center" }}>
